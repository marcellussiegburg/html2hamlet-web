...
-- 1. Start up GHCi
--
-- $ stack ghci html2hamlet-web:lib --no-load --work-dir .stack-work-devel
--
-- 2. Load this module
--
-- > :l app/DevelMain.hs
...
import Prelude
import Application (getApplicationRepl, shutdownHtml2Hamlet)
...
update = do
  ...
  start done = do
    ...
    forkFinally
      ...
      (\_ -> putMVar done () >> shutdownHtml2Hamlet site)
